...
import (
	...
	tequilapi_client "github.com/skytells-research/DNA/network/node/tequilapi/client"
...
// NewCommand constructs CLI based sdna UI with possibility to control quiting
...
// cliApp describes CLI based sdna UI
type cliApp struct {
	historyFile      string
...
func (c *cliApp) help() {
	info("sdna CLI tequilapi commands:")
...
func (c *cliApp) registration(argsString string) {
	...
	infof(" https://wallet.sdna.network/?part1=%s&part2=%s&s=%s&r=%s&v=%d\n",
