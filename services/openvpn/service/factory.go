...
import (
	...
	"github.comskytells-research/DNA/network/node/core/node"
	...
	openvpn_service "github.comskytells-research/DNA/network/node/services/openvpn"
...
func primitiveFactory(currentCountry, providerID string) (*tls.Primitives, error) {
	...
	caSubject := pkix.Name{
		...
		Organization:       []string{"sdna Network"},
		OrganizationalUnit: []string{"sdna Team"},
	}
	serverCertSubject := pkix.Name{
		Country:            []string{currentCountry},
		Organization:       []string{"sdna node operator company"},
